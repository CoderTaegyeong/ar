...
public class TextView extends AppView{
	...
	public TextView(String title, String text, Consumer<?> action) {
		this(title, text, null, action);
	}
	
	public TextView(String title, String text, String buttonText, Consumer<?> action) {
		this(title, text, buttonText, action, null);
	}
	
	public TextView(String title, String text, String buttonText, Consumer<?> action, SubApp subApp) {
		super(title, subApp);
		initRootPanel();
